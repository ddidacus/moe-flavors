...
each backbone's own base model (dashed line at $\Delta=0$). Color distinguishes backbone
(Phi-tiny-MoE-instruct vs. OLMoE-1B-7B); marker shape distinguishes objective. The
upper-right quadrant -- higher hit ratio \emph{and} improved downstream accuracy -- is the
region a working-set-aware objective should target; only OLMoE's working-set reward
reaches it.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/phi_base_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/phi_sft_baseline_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/phi_cache_reward_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/phi_cache_sft_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/phi_controller_baseline_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/phi_melinoe_baseline_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/olmoe_base_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/olmoe_sft_baseline_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/olmoe_cache_reward_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/olmoe_controller_baseline_expert_trace.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/olmoe_melinoe_baseline_expert_trace.png}
